...
Check version number in setup.json and aiida_shengbte/__init__.py and make sure
they match.
"""
...
import aiida_shengbte  # pylint: disable=wrong-import-position
version = aiida_shengbte.__version__
