...
FORCE_CONSTANTS_2ND = OverridableOption(
    "-fc2",
    "--force-constants-2nd",
    "fc2",
    help="Force Constants 2nd file path.",
)
FORCE_CONSTANTS_3RD = OverridableOption(
    "-fc3",
    "--force-constants-3rd",
    "fc3",
    help="Force Constants 3rd file path.",
)
...
SUPERCELL_MATRIX = OverridableOption(
    "--supercell-matrix",
    "supercell_matrix",
    nargs=3,
    type=click.INT,
