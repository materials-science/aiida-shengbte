...
class ShengBTECalculation(BaseCalculation):
    ...
    def define(cls, spec):
        ...
        spec.exit_code(
            201, "ERROR_KEY_IN_INPUT", message="The key inputed is invalid."
        )
        spec.exit_code(
            202,
            "ERROR_TYPE_IN_INPUT",
    ...
    def prepare_for_submission(self, folder):
        ...
        try:
            ...
            return (
                self.exit_codes[str(err)]
                if str(err) in self.exit_codes.keys()
