# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-shengbte
#
...
project = u"aiida-shengbte"
copyright_first_year = "2020"
copyright_owners = "PorYoung"
...
release = aiida_shengbte.__version__
...
html_use_opensearch = "http://aiida-shengbte.readthedocs.io"
...
htmlhelp_basename = "aiida-shengbte-doc"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(
        source_dir, os.pardir, os.pardir, "aiida_shengbte"
    )
    ...
    if os.path.isdir("/home/ias/miniconda3"):
        # local test
        cmd_path = os.path.join(
            "/home/ias/miniconda3/envs/aiida", "bin", "sphinx-apidoc"
        )
